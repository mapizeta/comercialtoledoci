...
<html lang="en">
  <head>
    ...
    <title>Comercial Toledo Admin Store</title>
      ...
      <div class="container">
        <div class="navbar-header">
          <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
            ...
            <a class="navbar-brand" href="<?php echo admin_url(); ?>">Comercial Toledo Admin Store</a>
        </div>
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            
            <li <?php if($this->uri->segment(2) == 'orders'){ echo 'class="active"';} ?>>
                <a href="<?php echo admin_url('orders'); ?>">Presupuestos</a>
            </li>
            
            <li class="dropdown">
                <a href="<?php echo admin_url('product'); ?>" class="dropdown-toggle" data-toggle="dropdown">Productos <b class="caret"></b></a>
                <ul class="dropdown-menu">
                    <li><a href="<?php echo admin_url('product'); ?>">Todos los Productos</a></li>
                    <li><a href="<?php echo admin_url('category'); ?>">Categorias</a></li>
                    <li><a href="<?php echo admin_url('manufacturers'); ?>">Fabricantes</a></li>
                </ul>
            </li>
            <!--
            ...
            <li <?php if($this->uri->segment(2) == 'users'){ echo 'class="active"';} ?>>
                <a href="<?php echo admin_url('user'); ?>">Usuarios</a>
            </li>
